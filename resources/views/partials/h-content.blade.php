    ...
    <main class="mx-3 my-4">
        ...
        <div class="container flex flex-nowrap my-4 mx-auto w-auto">
            ...
            <button type="button"
                class="px-2 py-1 mx-1 text-xs font-extrabold text-left text-white bg-[#656565] w-28 rounded-full">
                View All</button>
            <button type="button" class="py-1 text-xs font-extrabold text-center text-pinky bg-white w-2/4 rounded-full">
        ...
        <div id="content" class="max-w-full mx-auto">
            ...
            <div id="cards-container"
                class="md:masonry-2-col lg:masonry-4-col box-border mx-auto before:box-inherit after:box-inherit">
